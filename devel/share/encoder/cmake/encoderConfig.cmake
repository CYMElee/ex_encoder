...
if("TRUE" STREQUAL "TRUE")
  set(encoder_SOURCE_PREFIX /home/ubuntu/yajie_ws/ex_encoder/src/encoder)
  set(encoder_DEVEL_PREFIX /home/ubuntu/yajie_ws/ex_encoder/devel)
  set(encoder_INSTALL_PREFIX "")
  set(encoder_PREFIX ${encoder_DEVEL_PREFIX})
else()
  set(encoder_SOURCE_PREFIX "")
  set(encoder_DEVEL_PREFIX "")
  set(encoder_INSTALL_PREFIX /home/ubuntu/yajie_ws/ex_encoder/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/yajie_ws/ex_encoder/src/encoder/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/yajie_ws/ex_encoder/devel/lib;/opt/ros/noetic/lib)
